...
const WhatMakesUsDifferent = () => {
  return (
    <div className="containerWMUD">
      <div className="titleWMUD">What makes us different?</div>
      <div className="subtitleWMUD">Reimagining and rewiring self-care</div>
      <div className="contentWMUD">
